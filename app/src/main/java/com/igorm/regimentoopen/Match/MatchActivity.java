package com.igorm.regimentoopen.Match;
...
public class MatchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        intentMain = new Intent(MatchActivity.this, MainActivity.class);
    ...
    private void saveP2() {
        ...
        p2 = new Player(Long.parseLong(cod), cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.NAME)), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.LOSE))), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.GAMES_WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.GAMES_LOSE))), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.SETS_WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.SETS_LOSE))));
    }
    ...
    private void saveP1() {
        ...
        p1 = new Player(Long.parseLong(cod), cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.NAME)), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.LOSE))), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.GAMES_WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.GAMES_LOSE))), Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.SETS_WIN))),
                Integer.parseInt(cursorAux.getString(cursorAux.getColumnIndexOrThrow(Core.SETS_LOSE))));
    }
    ...
    private void save() {
        ...
        Toast.makeText(MatchActivity.this, "Dados atualizados!", Toast.LENGTH_SHORT).show();
        finish();
    }
